...
const EditCustomer: React.FC = () => {
  ...
  if (!formData) {
    return (
      <Layout title="تحميل..." backLink="/prospects">
  ...
  return (
    <Layout title={`${formData.firstName} ${formData.lastName} - تعديل`} backLink="/prospects">
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-6">تعديل بيانات الزبون</h2>
